...
class Picker extends WireUiComponent
{
    ...
    public function getDateFormatPreference(): int
    {
        try {
            // Try to get the date format using your DateHelpers class
            $dateHelper = new \App\Services\DateHelpers();
            return $dateHelper->date_format;
        } catch (\Exception $e) {
            // Fallback to international format if DateHelpers fails
            return 0;
        }
    }
