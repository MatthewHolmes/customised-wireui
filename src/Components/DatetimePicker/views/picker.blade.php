<x-dynamic-component
    ...
    :x-props="WireUi::toJs([
        ...
        'calendar' => [
            ...
            'monthNames'    => trans('wireui::messages.date_picker.months_short'),
        ...
        'dateFormatPreference' => app(\WireUi\Components\DatetimePicker\Picker::class)->getDateFormatPreference(),
...
>
    ...
    <x-wireui-wrapper::element
        ...
        x-model="display"
        x-show="selectedDates.length === 0"
        x-on:blur="handleManualInput($event.target.value)"
        x-on:keydown.enter="handleManualInput($event.target.value)"
    />
                ...
                <div x-show="tab !== 'time-picker'" class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        <x-dynamic-component
                            ...
                            gray flat rounded
                        >
                            <div class="rounded-full size-2 h-2 w-2 bg-slate-600"></div>
                        </x-dynamic-component>
                ...
                <template x-if="tab === 'months-picker'">
                    <div class="grid grid-cols-3 gap-2">
                        <template x-for="(name, index) in $props.calendar.monthNames" :key="`month.${name}`">
                            <button
                                class="cursor-pointer disabled:cursor-not-allowed px-2 py-4 text-xs text-gray-700 uppercase transition-all duration-150 ease-in-out border rounded-md outline-none outline-hidden border-primary-100 focus:ring-2 focus:ring-offset-2 disabled:bg-slate-200 disabled:opacity-50 disabled:border-slate-200"
                                :class="{
